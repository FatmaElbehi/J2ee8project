		   ...
		   <tr>
		      ...
		      <td>
		    	 	...
		    	 	<select name="categ" class="form-control">
         		 		<c:forEach items="${categories}" var="listCateg">        
		    ...
		    <tr>
		      ...
		      <td><textarea rows="6" cols="20" name="desc" class="form-control"></textarea></td>
		   </tr>
		   <tr>
		     <td><label class="control-label">Disponibility :</label></td>		   
		      <td><input type="text" name="disp" class="form-control"></td>
		   </tr>
		   <tr>
		   	  <td><label class="control-label">Photo :</label></td>		   
		      <td><input type="file" name="photo" size="50" class="form-control"/></td>
		   </tr>
		   </table>		   
		   <input type="submit" value="Save"  class="btn btn-danger" style="margin-left:650px;margin-top:20px;"/>
		</form>
		</div>
		${msg}
		</div>
